var explanations = {
    ...
    all_uips: "To calculate all possible UIPs, the algorithm finds every path from the most recent decision node (the largest node) to the conflict. All nodes that appear on every path are considered possible UIPs (see red nodes above).",
